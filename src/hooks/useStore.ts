...
import { findInDictByJoinedKey, getLocaleLocalStorage, getValidLocale, replacePlaceholders } from "~/utils"
        ...
        globalKey => {
            return {
                ...
                t: (key, ...parameters) => {
                    ...
                    return replacePlaceholders(template, onError, ...parameters)
                },
            }
        },
